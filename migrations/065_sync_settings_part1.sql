-- Migración 065: Sincronización de tabla settings (Parte 1)
...
REPLACE INTO `settings` (`id`, `setting_key`, `setting_value`) VALUES ('2', 'ticker_text', 'Bienvenido a moratalla-murcia.com ù Patrimonio Hist¾rico Digital');
