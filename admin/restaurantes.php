...
<?php elseif ($action === 'edit' || $action === 'add'):
    $r = ['id'=>'','nombre'=>'','calle'=>'','poblacion'=>'Moratalla','es_pedania'=>0,'municipio'=>'Moratalla','provincia'=>'Murcia',
          'codigo_postal'=>'30440','telefono1'=>'','telefono2'=>'','email'=>'','web'=>'','facebook'=>'','tripadvisor'=>'','gmap_url'=>'',
    ...
    <div class="card" style="flex:2; min-width:400px;">
        ...
        <form method="POST" action="?action=save&id=<?php echo $r['id']; ?>" enctype="multipart/form-data">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; margin-bottom:1rem;">
                ...
                <div>
                    <label class="flabel">Correo Electrónico (Email)</label>
                    <input type="email" name="email" value="<?php echo htmlspecialchars($r['email'] ?? ''); ?>" class="finput" placeholder="correo@ejemplo.com">
                </div>
                <div style="grid-column:1/-1;">
            ...
            <div style="display:flex; gap:1rem; flex-wrap:wrap;">
                ...
                <a href="restaurantes.php<?php echo !empty($r['id']) ? '#tr-'.$r['id'] : ''; ?>" class="btn" style="background:var(--gray-200);">Volver al listado</a>
                <?php if ($action === 'edit'): ?>
            ...
            <div style="display:flex; flex-direction:column; gap:1rem; margin-bottom:1.5rem;">
                ...
                <div style="background:white; border:1px solid #ddd; border-radius:8px; padding:0.9rem; display:flex; flex-direction:column; gap:0.5rem;">
                    ...
                    <div style="text-align:right; padding-top:0.4rem; border-top:1px solid #f0f0f0;">
                        <a href="?action=delete_img&img_id=<?php echo $img['id']; ?>&rid=<?php echo $id; ?>" onclick="return confirm('¿Eliminar definitivamente?');" style="color:#d32f2f; font-size:0.82rem; font-weight:600; text-decoration:none;">
